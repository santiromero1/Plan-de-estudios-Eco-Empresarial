/* ============================================================
   economia-empresarial.ts — Plan oficial de la Lic. en
   Economía Empresarial (UTDT), Plan 2021.
   Materias, áreas (con sus colores), correlativas y cuatrimestres.
   Estado inicial LIMPIO: todas 'pendiente', en su ubicación oficial.
...
export const economiaEmpresarial: CarreraPlan = {
  id: 'economia-empresarial',
  label: 'Economía Empresarial',
  notaAprobacion: 6,
  areas,
  terms,
  subjects,
